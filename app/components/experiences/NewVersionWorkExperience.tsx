  ...
  },
  {
    ...
    details: {
      ...
      keyAchievements: [
        ...
        "Assisted in maintaining AWS Lambda functions for backend processing and event-driven workflows",
        "Supported enterprise system configuration, implementation, and technical delivery across multiple projects",
        "Translated business and functional requirements into practical system solutions",
